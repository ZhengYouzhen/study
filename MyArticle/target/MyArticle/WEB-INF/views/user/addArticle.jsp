        ...
        <div class="layui-col-md12">
            <form id="addArticleForm" class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="typeId" id="type" lay-filter="typeId">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="hidden" name="firstImg" id="firstImg"/>
                </div>
                ...
                <div class="layui-form-item">
                    <input type="hidden" name="summary" id="editTest"/>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
...
<script>
    layui.use(['form', 'laytpl', 'layedit', 'upload'], function () {
        ...
        form.on('submit(fabu)', function (data) {
            ...
            $('#editTest').val(layedit.getText(editIndex));
